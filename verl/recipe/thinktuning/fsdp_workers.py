...
class Actor2RolloutRefWorker(Worker):
    """
    This worker can be instantiated as a standalone actor or a standalone rollout or a standalone reference policy
    or a hybrid engine based on the config.rollout
    """
    ...
    def __init__(self, config: DictConfig, role: str):
        ...
        self.role = role
        assert self.role in ["actor2", "rollout2", "ref2", "actor2_rollout", "actor2_rollout_ref"]

        self._is_actor = self.role in ["actor2", "actor2_rollout", "actor2_rollout_ref"]
        self._is_rollout = self.role in ["rollout2", "actor2_rollout", "actor2_rollout_ref"]
        self._is_ref = self.role in ["ref2", "actor2_rollout_ref"]
