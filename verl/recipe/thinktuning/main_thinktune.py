...
class TaskRunner:
    def run(self, config):
        ...
        #     Role.Actor2Rollout: ray.remote(Actor2RolloutRefWorker),
        # }

        global_pool_id = "global_pool"
        global_group_id = "global_group"
        m2_group_id = "m2_group"
        ...
        #     Role.Actor2Rollout: global_pool_id,
        # }

        # use group_id to map the roles to another group
        role_config_list: List[RoleLayoutConfigItem] = [
            RoleLayoutConfigItem(
                Role.ActorRollout, ray.remote(actor_rollout_cls),
